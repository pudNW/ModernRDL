    ...
    return (
        <div className='panel-container'>
            ...
            <div className='property-group'>
                <label htmlFor="fill" className='property-label'>Fill Color</label>
                <input
                    id='fill'
                    name='fill'
                    type='text'
            ...
            <div className='property-group'>
                <label htmlFor="x" className='property-label'>Position X</label>
                <input
                    id='x'
                    name='x'
                    type='number'
            ...
            <div className='property-group'>
                <label htmlFor="y" className='property-label'>Position Y</label>
                <input
                    id='y'
                    name='y'
                    type='number'
